...
using UnityEngine;
using Verse.AI;
using MadmanSleepTrainer;

namespace MadmanSleepTrainer
{
    public class WorkGiver_HaulToCryptoTrainer : WorkGiver_Scanner
    {
        	public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(ThisMod_ThingDefof.MM_CryptosleepNeurotrainer);
	...
	public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
	{
		...
		CompBiosculpterPod compBiosculpterPod = (CompBiosculpterPod)t.TryGetComp<SleepTrainerCore>();
